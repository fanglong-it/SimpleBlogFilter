...
public class ResendCodeServlet extends HttpServlet {
    ...
    private static final String RESEND_PAGE = "resendCodePage";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (accountDao.checkExistEmail(email)) {
                ...
                msg = "Your email not Present in DB!";
                url = RESEND_PAGE;
                url = (String) siteMap.get(RESEND_PAGE);
            }
            request.setAttribute("CONFIRM_MSG", msg);
        } catch (Exception e) {
            log("Error at ResendCodeServlet:" + e.toString());
        } finally {
